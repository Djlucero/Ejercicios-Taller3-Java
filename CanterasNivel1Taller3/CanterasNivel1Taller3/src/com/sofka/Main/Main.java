...
import com.sofka.Taller5.Ejercicio5_Ciclos;
import com.sofka.Taller6.Principal_Taller6;
import com.sofka.Taller7.Ejercicio7_Ciclos;
import com.sofka.Taller8.Ejercicio8;
	    ...
	    public static void main(String[] args) throws IOException {
	        do {
			    ...
			    private static boolean evaluarOpcion(int opcion) throws IOException {
					...
					case 5:
						Ejercicio5_Ciclos p5 = new Ejercicio5_Ciclos();
					    p5.main(null);
									    
					case 6:
						Principal_Taller6  p6= new Principal_Taller6 ();
					    p6.main(null);
						
					case 7:
						Ejercicio7_Ciclos p7 = new Ejercicio7_Ciclos();
					    p7.main(null);
